...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=D0FA7525-9E5E-49A5-B164-52D9B29D1B02")
        ...
        if api[0]['Category']['Name'] == "Good":
            category_description = "(0-50) Air quality is considered satisfactory, air pollution poses little or no risk."
            category_color = "good"
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=D0FA7525-9E5E-49A5-B164-52D9B29D1B02")
